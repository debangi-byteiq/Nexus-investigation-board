 ...
 *
 * ❗ IMPORTANT: Replace the `ncs_` prefix below with your actual
...
const TABLE = {
  case:       'ncs_case',
  person:     'ncs_person',
  caseEntity: 'ncs_caseentity',
  evidence:   'ncs_evidence',
} as const;

const COL = {
  // Case
  caseId:       'ncs_caseid',
  caseName:     'ncs_casename',
  caseNumber:   'ncs_casenumber',
  openDate:     'ncs_opendate',
  isActive:     'ncs_isactive',
  // Person
  personId:     'ncs_personid',
  personName:   'ncs_personname',
  dateOfBirth:  'ncs_dateofbirth',
  phoneNumber:  'ncs_phonenumber',
  isSuspect:    'ncs_issuspect',
  // Case Entity
  caseEntityId: 'ncs_caseentityid',
  entityName:   'ncs_entityname',
  entityType:   'ncs_entitytype',
  ceCase:       '_ncs_case_value',       // lookup → Case
  cePerson:     '_ncs_person_value',     // lookup → Person
  // Evidence
  evidenceId:     'ncs_evidenceid',
  evidenceName:   'ncs_evidencename',
  evidenceType:   'ncs_evidencetype',
  collectedDate:  'ncs_collecteddate',
  evCase:         '_ncs_case_value',         // lookup → Case
  evCaseEntity:   '_ncs_caseentity_value',   // lookup → CaseEntity
} as const;
